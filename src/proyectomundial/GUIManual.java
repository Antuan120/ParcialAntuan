...
public class GUIManual extends JFrame {
    ...
    private void pintarMenuSesion() {
        btnSesion.setIcon(new ImageIcon(getClass().getResource("/resources/icons/dashboard_selecciones.png")));
        btnSesion.setText("Sesion");
        btnSesion.setForeground(new java.awt.Color(255, 255, 255));

        JLabel vacioDashboardSesion = new JLabel();
        ...
        jPanelSesion.add(vacioDashboardSesion, BorderLayout.WEST);
        ...
        btnSesion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                accionDashboardSesion();
            }
        });
    }

    private void accionDashboardSesion() {
        //USUARIO
        JPanel panelUser = new JPanel();
        JLabel User = new JLabel("USUARIO: ");
        JTextField usua = new JTextField();
        usua.setPreferredSize(new Dimension(160, 30));
        panelUser.add(User);
        panelUser.add(usua);
        panelUser.setBackground(Color.gray);
        panelUser.setPreferredSize(new Dimension(200, 115));
        ...
        panelPass.add(pass);
        panelPass.setBackground(Color.gray);
        panelPass.setPreferredSize(new Dimension(200, 115));
       ...
       iniciosesion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                haySesion = sesionDAO.Validacion(usuario, contraseña);
                if (haySesion==true) {
        ...
        jPanelMain.add(panelUser);
        jPanelMain.add(panelPass);
        jPanelMain.add(iniciosesion);
